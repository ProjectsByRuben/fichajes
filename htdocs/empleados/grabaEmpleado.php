...
<html>
  ...
  <?php
        ...
        else
        {
          ...
          $var_consulta= "select c.nombre as categoria,d.nombre as departamento,e.dni,e.nombre,e.apellidos,e.iban
          from categorias c,departamentos d,empleados e
          where e.dni="."'".$_REQUEST["dni"]."'";
          ...
          if($stmt->fetch())
          {
            ...
            $insercion = "INSERT INTO empleados VALUES ('".$_REQUEST["dni"]
      ...
      ?>
              ...
              <tr><th>DNI</th><th>Departamento</th><th>Categoria</th><th>Nombre</th><th>Apellidos</th><th>IBAN</th></tr>
      <?php
              echo "<tr><td>".$_REQUEST["dni"]."</td>";
              echo "<td>".$_REQUEST["departamento"]."</td>";
              echo "<td>".$_REQUEST["categoria"]."</td>";
              echo "<td>".$_REQUEST["empleado"]."</td>";
              echo "<td>".$_REQUEST["apellidos"]."</td>";
              echo "<td>".$_REQUEST["iban"]."</td>";
              echo "</table>";
