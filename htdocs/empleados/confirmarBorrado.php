...
<div class="container mt-5">
    <?php
        echo "<h1>Empleado: </h1><h2>".$_REQUEST["empleado"]."</h2>";
        echo "<h1>DNI: </h1><h2>".$_REQUEST["dni"]."</h2><br>";
    ?>
...
<script>
    function confirmarBorrado() {
        var dni = "<?php echo $_REQUEST['dni']; ?>";
        
        Swal.fire({
            title: '¿Estás seguro de dar de baja el Empleado?',
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                ...
                Swal.fire(
                    ...
                    window.location.href = 'borraEmpleado.php?id=' + encodeURIComponent(dni);
                });
