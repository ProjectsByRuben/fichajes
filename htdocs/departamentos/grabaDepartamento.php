...
<html>
  ...
  <?php
        ...
        else
        {
          ...
          $var_consulta= "SELECT * FROM departamentos WHERE id_departamento=".$_GET["id_departamento"]; 
          ...
          if($stmt->fetch())
          {
            echo "<h3>Lo siento, no se ha podido dar de alta, ya existe un socio con el número".$_GET["horario"]."</h3>";
          }  else {
            $insercion = "INSERT INTO departamentos VALUES ('".$_GET["id_departamento"]
                               . "', '" . $_GET["departamento"]
                               . "', '" . $_GET["presupuesto"]
                               ."')";
      ...
      ?>
              ...
              <tr><th>Id Departamento</th><th>Nombre</th><th>Presupuesto Mensual</th></tr>
      <?php
              echo "<tr><td>".$_GET["id_departamento"]."</td>";
              echo "<td>".$_GET["departamento"]."</td>";
              echo "<td>".$_GET["presupuesto"]."</td>";
              echo "</table>";
