    ...
    <div class="container">
      ...
      <div class="panel panel-info">
        <div class="panel-heading text-center">Modificación de Horario</div>
          <form method="get" action=".\grabaTurnoModificado.php">
            <div class="form-group"> 
              <label>&nbsp;&nbsp;ID Turno:&nbsp;</label><input type="text" size="7" name="turno" value="<?php echo $_GET["turno"]; ?>" readonly>
            </div>
            <div class="form-group">
                    <select name="empleado">
                    <option value="">Asignar empleado</option>
                    <?php
                      $query = $obj_conexion -> query ("SELECT dni,nombre FROM empleados WHERE id_departamento=".$_GET["departamento"]." and id_categoria=".$_GET["categoria"]);
